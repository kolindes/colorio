#!/usr/bin/env python
# Copyright ASN BSD 3-Clause license, see LICENSE file.
...
setup(
    name=NAME,
    version=get_version(os.path.join('colorio', '__init__.py')),
    description='in/out colored strings painter',
    long_description=read_file('README.rst'),
    keywords='color colour paint string text variables text ansi windows',
    author='ASN',
    author_email='anizigman@gmail.com',
    maintainer='ANS',
    url='https://github.com/kolindes/colorio',
    license='BSD',
    packages=[NAME],
